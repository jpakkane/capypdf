...
PdfDocument::load_font(FT_Library ft, const char *fname, FontProperties props) {
    ...
    auto subfont_data_obj = add_object(DelayedSubsetFontData{font_source_id});
    auto subfont_descriptor_obj =
        add_object(DelayedSubsetFontDescriptor{font_source_id, subfont_data_obj});
    auto subfont_cmap_obj = add_object(DelayedSubsetCMap{font_source_id});
    auto subfont_obj =
