...
public:
    ...
    Type4Function(
        double *domain, int32_t num_domain, double *range, int32_t range_size, const char *code) {
        CapyPDF_Function *fn;
        CAPY_CPP_CHECK(capy_type4_function_new(domain, num_domain, range, range_size, code, &fn));
        _d.reset(fn);
    }
};
